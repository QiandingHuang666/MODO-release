...
python3 -u main.py --config=exps/clip+dol+proto_e15/cars_50_10.json 2>&1
echo "=== DONE GPU3: cars_50_10.json ==="
echo "=== GPU3: cub_20_20.json ==="
python3 -u main.py --config=exps/clip+dol+proto_e15/cub_20_20.json 2>&1
echo "=== DONE GPU3: cub_20_20.json ==="
echo "=== GPU3: imagenetr_20_20.json ==="
python3 -u main.py --config=exps/clip+dol+proto_e15/imagenetr_20_20.json 2>&1
echo "=== DONE GPU3: imagenetr_20_20.json ==="
echo "=== GPU3: sun_30_30.json ==="
python3 -u main.py --config=exps/clip+dol+proto_e15/sun_30_30.json 2>&1
