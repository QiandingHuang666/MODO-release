def get_model(model_name, args):
    ...
    if name=="proof":
        ...
        return Learner(args)
    elif name == "simplecil_clean":
        from models.simplecil_clean import Learner
        return Learner(args)
    elif name == "simpletexcil":
        from models.simpletexcil import Learner
        return Learner(args)
    elif name == "simplegdaclip":
        from models.simplegdaclip import Learner
        return Learner(args)
    elif name == "clip_fc":
        from models.clip_fc import Learner
        return Learner(args)
    elif name == "clip_mlp":
        from models.clip_mlp import Learner
        return Learner(args)
    elif name =="zs_clip":
